...
8
 */
package guia03teoriaej07;

import java.util.Scanner;

public class Guia03TeoriaEj07 {

    public static void main(String args[]) {
        Scanner variable = new Scanner(System.in);
        System.out.println("Ingrese un valor entre 1 y 4 para saber que tipo de bomba ha seleccionado: ");
        int tipoMotor = variable.nextInt();
